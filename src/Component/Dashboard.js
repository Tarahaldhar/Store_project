...
const Dashboard = () => {
    const tokenuse=useSelector(state=>state?.token?.token)
    console.log('usetokenselector', tokenuse);
const navigate=useNavigate()
    const [masterLoginToggle, setMasterLoginToggle] = useState(false)
    const [storeSignup, setStoreSignup] = useState(false)
    const getMasterdetails = useSelector(state => state?.masterLogin?.masterLogin)
    console.log('master', getMasterdetails?.tokens?.access);
    ...
    const handleMasterProfile = (e) => {
        // setMasterLoginToggle(true)
    }
  const handleStoreSinup=(e)=>{
    setStoreSignup(true)
navigate('/StoreSignup')
  }
    return (
        <div>
            <body id="page-top">
                        ...
                        <li className="nav-item">
                            ...
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                                <div className="bg-white py-2 collapse-inner rounded">
                                    ...
                                    <Link onClick={(e)=>handleStoreSinup(e)} data-toggle="modal" data-target="#exampleModal" 
                                    className="collapse-item">signup</Link>
                                    <Link  className="collapse-item">Cards</Link>
                                </div>
                            </div>
                        </li>
                                ...
                                <form
                                    ...
                                    <div className="input-group">
                                        ...
                                        <div className="input-group-append">
                                            <button className="btn btn-primary" id='searchbtn-header' type="button">
                                ...
                                <ul className="navbar-nav ml-auto">
                                        ...
                                        <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                            ...
                                            <a classNameName="dropdown-item d-flex align-items-center" href="#">
                                                <div classNameName="dropdown-list-image mr-3">
                                                    <img classNameName="rounded-circle" src="img/undraw_profile_2.svg"
                                                        alt="..." />
                                            ...
                                            <a classNameName="dropdown-item d-flex align-items-center" href="#">
                                                <div classNameName="dropdown-list-image mr-3">
                                                    <img classNameName="rounded-circle" src="img/undraw_profile_3.svg"
                                                        alt="..." />
                                            ...
                                            <a classNameName="dropdown-item d-flex align-items-center" href="#">
                                                <div classNameName="dropdown-list-image mr-3">
                                                    <img classNameName="rounded-circle" src="https://source.unsplash.com/Mv9hjnEUHR4/60x60"
                                                        alt="..." />
                                    ...
                                    <li className="nav-item dropdown no-arrow">
                                        <a className="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <span className="mr-2 d-none d-lg-inline text-gray-600 small">{getMasterdetails?.username}</span>
                                            <img className="img-profile rounded-circle btn" style={{ height: '3rem', width: '3rem' }} data-toggle="modal" data-target="#exampleModal"
                                                src="img/undraw_profile.svg" onClick={(e) => handleMasterProfile(e)} />
                                        </a>
            ...
            {masterLoginToggle && <MasterLoginForm />}
