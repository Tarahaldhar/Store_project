...
const Header = () => {
    ...
    console.log('master', getMasterdetails);
...
<ul className="navbar-nav ml-auto">
    ...
    <li className="nav-item dropdown no-arrow">
        <a className="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
            ...
            <img className="img-profile rounded-circle btn btn-primary" style={{ height: '3rem', width: '3rem', border:'none' }} data-toggle="modal" data-target="#exampleModal"
